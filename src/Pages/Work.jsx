...
import Assignment from "../assets/Assignment-planner.PNG";
...
const Work = () => {
  ...
  return (
    <div name="work" className="w-full pt-8 md:h-screen text-gray-300 bg-black">
      ...
      >
        <div className="pb-8">
          <p className="text-4xl font-bold inline border-b-4 text-light-gray border-orange">
            Work
          </p>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <GridItem
            bgImage={Assignment}
            spanText="React JS + Scss"
            demoLink="https://home-work-for-tadas.vercel.app/"
            codeLink="https://github.com/Blubas35/home-work-for-tadas"
            titleText="Assignment due date calculator and planner"
            bodyText="This responsive website was created using React and Scss. The website incorporates a form with input validation, enabling users to provide the necessary information. To generate the assignment schedule, I utilized React hooks and performed array manipulation."
          />
          {/*Grid item */}
          {/* <GridItem
                        bgImage={ReactBasics}
