    ...
    return (
        <div name='contact' className='w-full h-full bg-[#0a192f] flex justify-center items-center p-4'>
            <form action='https://getform.io/f/ff8cf66e-dc56-4ef4-8566-ac034364dcf7' method='POST' className='flex flex-col max-w-[600px] w-full'>
                <div className='pb-8'>
                    <p className='text-4xl font-bold inline border-b-4 border-pink-600 text-gray-300'>Let's Chat</p>
                ...
                <textarea className='bg-[#ccd6f6]' name='message' row='10' placeholder='Message'></textarea>
